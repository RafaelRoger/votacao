        ...
        <div class="container-xl px-4 mt-n10">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div id="default">
                        <div class="card mb-4">
                            <div class="card-header">Formulário de registro de musica</div>
                            <div class="card-body">
                                <!-- Component Preview-->
                                <div class="sbp-preview">
                                    <div class="sbp-preview-content">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            @csrf
                                            <div class="mb-3">
                                                <label for="fullNameControlInput">Cantor</label>
                                                <input class="form-control" id="fullNameControlInput" type="text"
                                                    placeholder="Rafael Rogério Munguambe" name="singer" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1">Titulo da musica</label>
