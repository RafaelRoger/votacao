                            ...
                            <table id="datatablesSimple" class="datatable-table">
                                ...
                                <tbody>
                                    ...
                                    <tr data-index="0">
                                        <td>{{ $user->name }}</td>
                                        <td>{{ $user->email }}</td>
                                        <td>{{ $user->user_position->level }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-datatable btn-icon btn-transparent-dark" data-toggle="modal" data-target="#exampleModal"><svg
                                                ...
                                                </svg><!-- <i class="fa-regular fa-trash-can"></i> Font Awesome fontawesome.com --></button>
                                        </td>
                                    </tr>
                                    @endforeach
